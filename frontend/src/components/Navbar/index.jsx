    ...
    <>
      <nav className={`navbar ${scrolled ? 'navbar-scrolled' : ''}`}>
        <div className="navbar-inner">
          ...
          <div className="navbar-links">
            ...
            <Link to="/search?q=" className={`nav-link ${location.pathname === '/search' ? 'active' : ''}`}>Search</Link>
                  ...
                  <div className="navbar-user" onClick={() => setMenuOpen(!menuOpen)}>
                    ...
                    {menuOpen && (
                      <div className="navbar-dropdown">
                        ...
                        <Link to="/offers/new" className="dropdown-item" onClick={() => setMenuOpen(false)}>Post an Offer</Link>
                        <div className="dropdown-divider" />
      ...
      {mobileOpen && (
        <div className="mobile-menu">
          ...
          <Link to="/search?q=" className="mobile-link" onClick={() => setMobileOpen(false)}>🔍 Search</Link>

          {user ? (
            <>
              <Link to="/offers/new" className="mobile-link" onClick={() => setMobileOpen(false)}>✚ Post Offer</Link>
              <Link to={`/users/${user.id}`} className="mobile-link" onClick={() => setMobileOpen(false)}>👤 My Profile</Link>
              <div className="mobile-divider" />
              <button className="mobile-link mobile-link-danger" onClick={handleLogout}>Log Out</button>
            </>
          ) : (
            <>
              <div className="mobile-divider" />
              <Link to="/login" className="mobile-link" onClick={() => setMobileOpen(false)}>Log In</Link>
              <Link to="/register" className="mobile-link mobile-link-accent" onClick={() => setMobileOpen(false)}>Get Started Free →</Link>
            </>
          )}
        </div>
      )}
